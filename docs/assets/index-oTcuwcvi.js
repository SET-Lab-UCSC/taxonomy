...
(function(module, exports$1) {
  ((e, t) => {
    ...
    function i(m2) {
      var n2, s2, a2, t, o2 = Math.pow(2, 53), h3 = -o2, u2 = /^\s*-?(\d+\.?|\.\d+|\d+\.\d+)([eE][-+]?\d+)?\s*$/, d2 = /^((\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z)))$/, i2 = this, r2 = 0, f2 = 0, l2 = false, e = false, c2 = [], p3 = { data: [], errors: [], meta: {} };
      function y2(e2) {
        return "greedy" === m2.skipEmptyLines ? "" === e2.join("").trim() : 1 === e2.length && 0 === e2[0].length;
      }
      function g2() {
        if (p3 && a2 && (k("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + v.DefaultDelimiter + "'"), a2 = false), m2.skipEmptyLines && (p3.data = p3.data.filter(function(e3) {
          return !y2(e3);
        })), _2()) {
          ...
          if (p3) if (Array.isArray(p3.data[0])) {
            for (var e2 = 0; _2() && e2 < p3.data.length; e2++) p3.data[e2].forEach(t2);
            p3.data.splice(0, 1);
        ...
        var r3;
        p3 && (m2.header || m2.dynamicTyping || m2.transform) && (r3 = 1, !p3.data.length || Array.isArray(p3.data[0]) ? (p3.data = p3.data.map(i3), r3 = p3.data.length) : p3.data = i3(p3.data, 0), m2.header && p3.meta && (p3.meta.fields = c2), f2 += r3);
      }
      function _2() {
      ...
      U(m2.step) && (t = m2.step, m2.step = function(e2) {
        p3 = e2, _2() ? g2() : (g2(), 0 !== p3.data.length && (r2 += e2.data.length, m2.preview && r2 > m2.preview ? s2.abort() : (p3.data = p3.data[0], t(p3, i2))));
      }), this.parse = function(e2, t2, i3) {
        var r3 = m2.quoteChar || '"', r3 = (m2.newline || (m2.newline = this.guessLineEndings(e2, r3)), a2 = false, m2.delimiter ? U(m2.delimiter) && (m2.delimiter = m2.delimiter(e2), p3.meta.delimiter = m2.delimiter) : ((r3 = ((e3, t3, i4, r4, n3) => {
          var s3, a3, o3, h4;
          n3 = n3 || [",", "	", "|", ";", v.RECORD_SEP, v.UNIT_SEP];
          for (var u3 = 0; u3 < n3.length; u3++) {
            for (var d3, f3 = n3[u3], l3 = 0, c3 = 0, p4 = 0, g3 = (o3 = void 0, new E({ comments: r4, delimiter: f3, newline: t3, preview: 10 }).parse(e3)), _3 = 0; _3 < g3.data.length; _3++) i4 && y2(g3.data[_3]) ? p4++ : (d3 = g3.data[_3].length, c3 += d3, void 0 === o3 ? o3 = d3 : 0 < d3 && (l3 += Math.abs(d3 - o3), o3 = d3));
            0 < g3.data.length && (c3 /= g3.data.length - p4), (void 0 === a3 || l3 <= a3) && (void 0 === h4 || h4 < c3) && 1.99 < c3 && (a3 = l3, s3 = f3, h4 = c3);
          }
          return { successful: !!(m2.delimiter = s3), bestDelimiter: s3 };
        })(e2, m2.newline, m2.skipEmptyLines, m2.comments, m2.delimitersToGuess)).successful ? m2.delimiter = r3.bestDelimiter : (a2 = true, m2.delimiter = v.DefaultDelimiter), p3.meta.delimiter = m2.delimiter), b(m2));
        return m2.preview && m2.header && r3.preview++, n2 = e2, s2 = new E(r3), p3 = s2.parse(n2, t2, i3), g2(), l2 ? { meta: { paused: true } } : p3 || { meta: { paused: false } };
        ...
        e = true, s2.abort(), p3.meta.aborted = true, U(m2.complete) && m2.complete(p3), n2 = "";
    ...
    function E(C) {
      ...
      this.parse = function(i2, t, r2) {
        ...
        for (var p3 = i2.indexOf(S, z), g2 = i2.indexOf(O, z), _2 = new RegExp(P(j) + P(F), "g"), m2 = i2.indexOf(F, z); ; ) if (i2[z] === F) for (m2 = z, z++; ; ) {
          ...
          if (F === j && i2[m2 + 1] === j) m2++;
            ...
            -1 !== p3 && p3 < m2 + 1 && (p3 = i2.indexOf(S, m2 + 1));
            var y2 = v2(-1 === (g2 = -1 !== g2 && g2 < m2 + 1 ? i2.indexOf(O, m2 + 1) : g2) ? p3 : Math.min(p3, g2));
            if (i2.substr(m2 + 1 + y2, e) === S) {
              d2.push(i2.substring(z, m2).replace(_2, F)), i2[z = m2 + 1 + y2 + e] !== F && (m2 = i2.indexOf(F, z)), p3 = i2.indexOf(S, z), g2 = i2.indexOf(O, z);
              break;
            }
            y2 = v2(g2);
            if (i2.substring(m2 + 1 + y2, m2 + 1 + y2 + s2) === O) {
              if (d2.push(i2.substring(z, m2).replace(_2, F)), b2(m2 + 1 + y2 + s2), p3 = i2.indexOf(S, z), m2 = i2.indexOf(F, z), o2 && (R(), M)) return w();
          ...
          if (-1 === g2) return w();
          z = g2 + s2, g2 = i2.indexOf(O, z), p3 = i2.indexOf(S, z);
        } else if (-1 !== p3 && (p3 < g2 || -1 === g2)) d2.push(i2.substring(z, p3)), z = p3 + e, p3 = i2.indexOf(S, z);
        else {
          if (-1 === g2) break;
    ...
    }, v.RECORD_SEP = String.fromCharCode(30), v.UNIT_SEP = String.fromCharCode(31), v.BYTE_ORDER_MARK = "\uFEFF", v.BAD_DELIMITERS = ["\r", "\n", '"', v.BYTE_ORDER_MARK], v.WORKERS_SUPPORTED = !s && !!n.Worker, v.NODE_STREAM_INPUT = 1, v.LocalChunkSize = 10485760, v.RemoteChunkSize = 5242880, v.DefaultDelimiter = ",", v.Parser = E, v.ParserHandle = i, v.NetworkStreamer = f, v.FileStreamer = l, v.StringStreamer = c, v.ReadableStreamStreamer = p2, n.jQuery && ((d = n.jQuery).fn.parse = function(o2) {
      var i2 = o2.config || {}, h3 = [];
    ...
    }), (f.prototype = Object.create(u.prototype)).constructor = f, (l.prototype = Object.create(u.prototype)).constructor = l, (c.prototype = Object.create(c.prototype)).constructor = c, (p2.prototype = Object.create(u.prototype)).constructor = p2, v;
  });
})(papaparse_min);
...
const useDataStore = /* @__PURE__ */ defineStore("data", () => {
  ...
  function observationsByTechnique(name) {
    return observations.value.filter(
      (o) => (o.Interaction_Technique || "").split(",").map((t) => t.trim()).includes(name)
    );
  }
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        __props.show && __props.technique ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "modal",
...
const _hoisted_1$2 = { class: "main-content" };
const _hoisted_2$1 = {
  key: 0,
  class: "loading-state"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", _hoisted_1$2, [
        ...
        createVNode(_sfc_main$4, {
          ...
          show: !!selectedTechnique.value,
          onClose: closeModal
        }, null, 8, ["technique", "observations", "show"])
      ]);
    };
  }
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("header", _hoisted_1$1, [
        createBaseVNode("h1", {
          class: "site-title font-display gradient-text",
          onClick: _cache[0] || (_cache[0] = ($event) => unref(router2).push("/"))
        }, " Spatial Interaction Vault "),
        _cache[1] || (_cache[1] = createBaseVNode("div", { class: "header-buttons" }, [
          createBaseVNode("button", { class: "btn btn-outline" }, [
            createBaseVNode("b", null, "Submit an observation")
          ]),
          createBaseVNode("button", { class: "btn btn-primary" }, [
            createBaseVNode("b", null, "About")
          ])
        ], -1))
      ]);
    };
